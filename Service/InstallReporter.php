<?php
/**
 * Standalone install + heartbeat reporter for Panth_PerformanceDebugger.
 *
...
class InstallReporter
{
    ...
    public const MAGENTO_MODULE = 'Panth_PerformanceDebugger';

    /** Composer package name reported to the receiver. */
    public const COMPOSER_PACKAGE = 'mage2kishan/module-performance-debugger';
